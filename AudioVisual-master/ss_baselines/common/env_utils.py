...
REPLICA_SCENES = ['apartment_0', 'apartment_1', 'apartment_2', 'frl_apartment_0', 'frl_apartment_1',
                  'frl_apartment_2', 'frl_apartment_3', 'frl_apartment_4', 'frl_apartment_5', 'office_0',
                  'office_1', 'office_2', 'office_3', 'office_4', 'hotel_0',
...
def construct_envs(
    ...
    # soga, 所以只有REPLICA_SCENES这个list的原因是replica它imbalance
    # 之所以为了balance是为了vec-env的并行度更好吧

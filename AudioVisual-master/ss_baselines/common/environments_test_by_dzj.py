...
@baseline_registry.register_env(name="AudioNavRLEnv_Test")
class AudioNavRLEnv_Test(habitat.RLEnv):
    ...
    def hack_observations(self, observations):
        ...
        # print("#############:self._env.sim")
        # print(self._env.sim)
        # print(dir(self._env.sim))
        # print("#############:self.habitat_env")
        # print(self.habitat_env)
        # print(dir(self.habitat_env))
        # print("#############:self.habitat_env.sim")
        # print(self.habitat_env.sim)
        # print(dir(self.habitat_env.sim))
        #
        # print("#############:self.habitat_env.sim._sensor_suite")
        # print(self.habitat_env.sim._sensor_suite)
        # print(dir(self.habitat_env.sim._sensor_suite))
        #
        #
        # print('!!!!!!!!!!!!')
        # set_trace()

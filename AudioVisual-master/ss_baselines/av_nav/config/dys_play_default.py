...
_C = CN()
_C.SEED = 0
_C.BASE_TASK_CONFIG_PATH = "./av_nav/config/audionav/mp3d/test_telephone/audiogoal_rgb.yaml"
...
def get_config(
    ...
    set_trace()
    config.BASE_TASK_CONFIG_PATH = './av_nav/config/audionav/mp3d/test_telephone/audiogoal_rgb.yaml'

...
class Train:
    ...
    def _move_batch(self, batch):
        ...
        return (
            ...
            batch_sound_id.long().to(self.device),
    ...
    def _step(self, batch):
        ...
        polar_predict, angle_logits, action_logits = self.train_model(
            batch_audio,
            batch_rgb,
            batch_depth,
            batch_pose,
        ...
        return loss_total, loss_action, loss_polar, loss_angle, radius_mae, theta_mae, action_acc, angle_acc
    ...
    def train(self):
        ...
        for ep in range(self.epoch):
            ...
            for batch in self.train_loader:
                loss_total, loss_action, loss_polar, loss_angle, radius_mae, theta_mae, action_acc, angle_acc = self._step(batch)
                ...
                print(
                    ...
                    f"action loss {loss_action:.6f}, polar loss {loss_polar:.6f}, angle loss {loss_angle:.6f}"
                )
    ...
    def validate(self, step):
        ...
        with torch.no_grad():
            for batch in self.val_loader:
                total_loss, action_loss, polar_loss, angle_loss, radius_mae, theta_mae, action_acc, angle_acc = self._step(batch)
